...
// Using standard CSS animation for the infinite spin to keep it off the JS main thread
const Mandala = ({ className }: { className: string }) => (
  <img 
    ...
    className={`absolute opacity-15 pointer-events-none mix-blend-multiply animate-spin-extremely-slow ${className}`}
    style={{ 
      filter: 'invert(30%) sepia(80%) saturate(400%) hue-rotate(350deg)',
...
export default function MainCard({ onFinish }: { onFinish: () => void }) {
  ...
  useEffect(() => {
    ...
    const speedPerMs = isMobile ? 0.06 : 0.07; 
    ...
    const startScrolling = () => {
      ...
      const scroll = (currentTime: number) => {
        ...
        // Cap at 32ms to prevent jumps if the browser stutters momentarily
        const deltaTime = Math.min(rawDelta, 32);
  ...
  return (
    <>
      ...
      <motion.div
        ...
        className="absolute inset-0 overflow-y-auto overflow-x-hidden bg-[#fdfbf7] z-30 transform-gpu translate-z-0"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        exit={{ opacity: 0 }}
            ...
            >
              ...
              <div className="flex flex-col md:flex-row items-center justify-center gap-12 md:gap-24">
                ...
                <div className="flex flex-col items-center justify-center relative">
                  <div 
                    className="w-24 h-24 border-4 border-dashed border-amber-500 rounded-full flex items-center justify-center mb-2 shadow-[0_0_15px_rgba(245,158,11,0.5)] animate-spin-extremely-slow"
                ...
                <div className="space-y-8 bg-gradient-to-br from-amber-50 to-orange-50 p-8 rounded-3xl border border-amber-200 shadow-inner relative overflow-hidden">
                  ...
                  <div className="space-y-6 mt-8 relative z-10">
                    ...
                    <div className="flex justify-between items-center text-2xl">
                      ...
                      <span className="font-bold text-[#8b0000] text-2xl md:ml-10">स्वागत बारात एवं प्रीतिभोज</span>
                    </div>
                  </div>
                </div>
